...
# classes and routines used to support the analyzeVoids script

import os
import glob
import voidProject as vp
import numpy as np
...
class Sample:
  ...
  def __init__(self, dataFile="", fullName="", 
               ...
               dataType="observation", numSubVolumes=2, 
               boxLen=1024, usePecVel=False):
  ...
  if dataType == "observation":
    ...
    conf="""
      ...
      """ % (datafile, zobovDir+"/zobov_slice_"+sampleName,
             zobovDir+"/zobov_slice_"+sampleName+".par",
             includePecVelString,
             0, sample.boxLen, 0, sample.boxLen,
...
def launchZobov(sample, binPath, zobovDir=None, logDir=None, continueRun=None,
                dataType=None, numSubVolumes=None):
