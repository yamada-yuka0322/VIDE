...
defaultsFile = "/mnt/data/yuka/repository/vide_public/python_tools/pipeline_source/defaults.py"
    ...
    for (iRedshift, redshift) in enumerate(redshifts):
      ...
      if dataFormat == "multidark" or dataFormat == "sdf":
        ...
        if prevSubSample == -1 and dataFormat == "sdf":
          ...
          SDFcvt_PATH = "/mnt/data/yuka/repository/vide_public/build/temp.linux-x86_64-cpython-310/external/libsdf/apps/SDFcvt/SDFcvt.x86_64"
...
if (args.hod or args.all) and haloFileBase != "":
  ...
  for (iRedshift, redshift) in enumerate(redshifts):
    ...
    for thisHod in hodParmList:
      ...
      HOD_PATH = "/mnt/data/yuka/repository/vide_public/build/temp.linux-x86_64-cpython-310/c_tools/hod/hod"
