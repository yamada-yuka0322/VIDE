/*
  ...
  ../src/gengetopt -i /mnt/data/yuka/repository/vide_public/build/temp.linux-x86_64-cpython-310/ep_build/gengetopt-prefix/src/gengetopt/doc/sample1.ggo -Fcmdline1 --long-help -u --show-required 
