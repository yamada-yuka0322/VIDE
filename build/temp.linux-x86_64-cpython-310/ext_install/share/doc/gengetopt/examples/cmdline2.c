/*
  ...
  ../src/gengetopt --input=/mnt/data/yuka/repository/vide_public/build/temp.linux-x86_64-cpython-310/ep_build/gengetopt-prefix/src/gengetopt/doc/sample2.ggo --func-name=my_cmdline_parser --file-name=cmdline2 --unamed-opts --no-handle-help --no-handle-version 
